...
public class PlaceHolderView extends RecyclerView {
    ...
    private com.sam.placer.PlaceHolderViewBuilder mBuilder;
    ...
    public PlaceHolderView(Context context) {
        super(context);
        setupView(context, new ViewAdapter<>(context), new com.sam.placer.PlaceHolderViewBuilder(context, this));
    }
     ...
     * @param builder
     */
    protected void setupView(Context context, ViewAdapter viewAdapter, com.sam.placer.PlaceHolderViewBuilder builder){
     ...
     * @return
     */
    private com.sam.placer.PlaceHolderViewBuilder builder(){
        return mBuilder;
    }
     ...
     * @return
     */
    public com.sam.placer.PlaceHolderViewBuilder getBuilder() {
        return mBuilder;
    }
