...
import com.sam.placer.annotations.swipe.SwipeCancelState;
import com.sam.placer.annotations.swipe.SwipeIn;
import com.sam.placer.annotations.swipe.SwipeInState;
import com.sam.placer.annotations.swipe.SwipeOut;
import com.sam.placer.annotations.swipe.SwipeOutState;
import com.sam.placer.annotations.swipe.SwipeView;
...
public class SwipeViewBinder<T, V extends FrameLayout> extends ViewBinder<T, V> {
    ...
    private int mSwipeType = com.sam.placer.SwipePlaceHolderView.SWIPE_TYPE_DEFAULT;
    private View mSwipeInMsgView;
    private View mSwipeOutMsgView;
    private SwipeDecor mSwipeDecor;
    private com.sam.placer.SwipePlaceHolderView.SwipeOption mSwipeOption;
    ...
    protected void bindView(V promptsView, int position, int swipeType, SwipeDecor decor,
                            com.sam.placer.SwipePlaceHolderView.SwipeOption swipeOption, SwipeCallback callback) {
    ...
    protected void setOnTouch(){
        ...
        switch (mSwipeType){
            case com.sam.placer.SwipePlaceHolderView.SWIPE_TYPE_DEFAULT:
                setDefaultTouchListener(mLayoutView);
                break;
            case com.sam.placer.SwipePlaceHolderView.SWIPE_TYPE_HORIZONTAL:
                setHorizontalTouchListener(mLayoutView);
                break;
            case com.sam.placer.SwipePlaceHolderView.SWIPE_TYPE_VERTICAL:
    ...
    private void animateSwipeRestore(final View v, int originalTopMargin, int originalLeftMargin, int swipeType){
        ...
        if(swipeType == com.sam.placer.SwipePlaceHolderView.SWIPE_TYPE_DEFAULT
                || swipeType == com.sam.placer.SwipePlaceHolderView.SWIPE_TYPE_HORIZONTAL){
        ...
        if(swipeType == com.sam.placer.SwipePlaceHolderView.SWIPE_TYPE_DEFAULT
                || swipeType == com.sam.placer.SwipePlaceHolderView.SWIPE_TYPE_VERTICAL){
