...
public class TrialReceivePassengerActivity extends Activity implements ApiManager.APIFETCHER {
    ...
    @Bind(R.id.cancel_btn) LinearLayout cancelBtn;
    @Bind(R.id.activity_countdown_timer_days) ProgressWheel mProgresdsWheel;
    @Bind(R.id.cancel_layout) LinearLayout cancelLayout;
    @Bind(R.id.map_image) CircleImageView mapImage;
    @Bind(R.id.time_txt) TextView timeTxt;
    @Bind(R.id.main_layout_pickup_txt) TextView mainLayoutPickupTxt;
    @Bind(R.id.main_layout) LinearLayout mainLayout;
    @Bind(R.id.ride_expire_pick_address_txt) TextView rideExpirePickAddressTxt;
    @Bind(R.id.ride_expire_drop_address_txt) TextView rideExpireDropAddressTxt;
    @Bind(R.id.ride_expire_ok_btn) LinearLayout rideExpireOkBtn;
    @Bind(R.id.ride_expire_layout) LinearLayout rideExpireLayout;
    @Bind(R.id.accept_ride_btn) LinearLayout acceptRideBtn;
    @Bind(R.id.expire_msg) TextView expireMsg;
    @Bind(R.id.cash_layout) LinearLayout cash_Layout;
    @Bind(R.id.card_layout) LinearLayout card_Layout;
