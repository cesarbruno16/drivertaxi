package com.ride.taxiDriver.locationaltrackerclasses.constants;

/**
 * Created by Yahya Bayramoglu on 19/02/16.
 */
public class FailType {
    ...
    public static final int NETWORK_NOT_AVAILABLE = 4;   ///   checked when internet not available
