...
//import com.apporio.mapaddressgetteractivity.Locational.constants.FailType;
...
public abstract class LocationReceiver {
     ...
     * It will pass an integer value from {@linkplain }
    ...
    /**
     * This method will be invoked if only you use android.location.LocationSession
